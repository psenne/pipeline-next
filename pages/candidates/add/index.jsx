...
export default function AddCandidate() {
    ...
    const panes = [
        ...
        },
        {
            ...
            render: () => (
                <Tab.Pane>
                    <Form.TextArea name="resume_text" onChange={HandleTextInput} value={candidate.resume_text} />
                </Tab.Pane>
            ),
        },
    ]
        ...
        <>
            <Segment>
                <Form>
                    ...
                    <Segment>
                        <Form.Input name="firstname" type="text" required placeholder="First name" onChange={HandleTextInput} value={candidate.firstname} />
                        <Form.Input name="lastname" type="text" required placeholder="Last name" onChange={HandleTextInput} value={candidate.lastname} />
